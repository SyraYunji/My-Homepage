...
const PlatformDetail = () => {
  return (
    ...
    >
      {/* 타이틀 */}
      <h1 className={styles.title}>플랫폼 더 자세히 보기</h1>
      ...
      <section className={styles.section}>
        ...
        />
        <p className={styles.description}>
          15개의 질문으로 구성되며, 정치, 외교, 사회 카테고리에서 **진보와 보수 선택 갯수를 분석**합니다.
        </p>
        <img
        ...
        />
        <p className={styles.description}>
          결과 화면에서는 사용자의 성향에 맞는 **역사적 인물 추천**을 통해 정치적 이해를 돕습니다.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <img
          src="/images/district-selection.png"
          alt="구 선택 화면"
          className={styles.image}
        />
        <p className={styles.description}>
          사용자는 구를 선택하여 해당 지역의 **구청장과 국회의원 정보를 조회**할 수 있습니다.
        </p>
        <img
        ...
        <img
          src="/images/mayor-info.png"
          alt="구청장 정보 화면"
          className={styles.image}
        />
        <p className={styles.description}>
          구청장 정보 화면에서는 기본 정보와 함께 **정책 이행률**을 그래프로 제공합니다.
        </p>
        <img
          src="/images/assemblyman-info.png"
          alt="국회의원 정보 화면"
          className={styles.image}
        />
        <p className={styles.description}>
          국회의원 정보 화면에서는 발의 법안과 의안 투표 현황이 실시간으로 조회 가능합니다.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        />
        <p className={styles.description}>
          **POLITRACKER Chatbot**을 통해 정치 용어 설명, 최신 뉴스 질의 응답 등 실시간 도움을 받을 수 있습니다.
        </p>
      </section>
